    ...
    <div id="OverallContainer" className="w-screen h-screen bg-black justify-center items-center flex">
      <div id="BackgroundContainer" className="w-screen h-screen grow shrink basis-0 self-stretch bg-neutral-900 justify-start items-start inline-flex">
        ...
        <div id="MiddleContainer" className="w-full self-stretch items-center grow shrink relative rounded-[20px]">
          <div id="MiddleGrey" className="w-full h-5/6 top-[32px] flex relative bg-neutral-700 rounded-[20px] justify-center items-center">
            <div id="MiddleText" className="w-5/6 h-full relative flex flex-col justify-center items-center">
              <div id="HeaderContainer" className="w-full h-1/6 left-0 top-0 self-stretch relative">
                ...
                <div className="w-full relative text-center text-gray-200 text-xl font-medium leading-relaxed">Lorem Ipsum</div>
              </div>
              <div id="AgentNameContainer" className="w-full h-1/12 left-0 top-[10px] relative">
                <div className="w-fit left-0 top-0 relative text-gray-200 text-xs font-medium leading-normal">Agent Name</div>
                <div className="w-fit h-min px-4 py-3 mt-1 left-0 relative bg-neutral-900 rounded-xl gap-3 inline-flex">
                  <div className="grow shrink basis-0 text-gray-100 text-opacity-50 text-xs font-normal leading-tight">Lorem Ipsum</div>
                </div>
              </div>
              <div id="ObjectiveContainer" className="w-1/2 h-1/4 top-[30px] relative">
              ...
              <div id="TypeContainer" className="w-5/6 h-1/5 top-[40px] flex relative">
                <div id="BrowsingContainer" className="w-1/3 h-1/3 pl-4 pr-6 py-2.5 left-0 top-0 absolute bg-neutral-900 rounded-xl border border-neutral-900 justify-start items-center gap-6 inline-flex">
                  ...
                  <div id="BrowsingText" className="grow shrink basis-0 self-stretch justify-start items-center gap-1 flex">
                    <div className="grow shrink basis-0 text-white text-base font-semibold leading-loose">Browsing</div>
                ...
                <div id="DefaultContainer" className="w-1/3 h-1/3 pl-4 pr-6 py-2.5 left-[315.87px] top-0 absolute bg-neutral-900 rounded-xl shadow border border-gray-100 justify-start items-center gap-6 inline-flex">
                  ...
                  <div id="DefaultText" className="grow shrink basis-0 self-stretch justify-start items-center gap-1 flex">
                    <div className="grow shrink basis-0 text-white text-base font-semibold leading-loose">Default</div>
                  </div>
                </div>
                <div id="CodingContainer" className="w-1/3 h-1/3 pl-4 pr-6 py-2.5 left-0 top-[61px] absolute bg-neutral-900 rounded-xl border border-neutral-900 justify-start items-center gap-6 inline-flex">
                  ...
                  <div id="CodingText" className="grow shrink basis-0 self-stretch justify-start items-center gap-1 flex">
                    <div className="grow shrink basis-0 text-white text-base font-semibold leading-loose">Coding</div>
                    <div className="p-2 rounded-[40px] justify-center items-center gap-2 flex" />
                  </div>
                </div>
                <div id="FileContainer" className="w-1/3 h-1/3 px-5 py-2.5 left-[315.87px] top-[61px] absolute bg-neutral-900 rounded-xl justify-start items-center gap-6 inline-flex">
                  ...
                  <div id="FileText" className="grow shrink basis-0 self-stretch justify-start items-center gap-1 flex">
                    <div className="grow shrink basis-0 text-white text-base font-semibold leading-loose">File (Pro)</div>
              ...
              <div id="AutoGenSwitchContainer" className="w-1/2 h-1/12 top-[26px] relative">
                ...
                <div className="w-max left-14 top-0 absolute text-white text-base font-medium leading-loose">Automatically generate tasks</div>
              </div>
